...
function App(){
 ...
 return <div id="top">
  ...
  <main>
   ...
   <section id="about" className="section container"><SectionTitle eyebrow="01 / ABOUT" ></SectionTitle><div className="testCard"><div className="testTitle">แนะนำตัว</div>{['ผมคือใคร? : พนัสเหล่าตระกูลงาม','อยากทำงานสายไหน? : งานที่เกี่ยวข้องกับ Full Stack Web Development หรือ สายงานที่ใกล้เคียง','Skill เด่นคืออะไร? : Javascript'].map((t,i)=><div className="testRow" key={t}><b>{String(i+1).padStart(2,'0')}</b><span>{t}</span></div>)}</div></section>
